app.controller('AppScoresController', ['$scope', '$state', '$log', 'applicationService', '$sce', '$http', '$window', 'modalService', 'modalMessageService', '$uibModal', '$rootScope', function ($scope, $state, $log, applicationService, $sce, $http, $window, modalService, modalMessageService, $uibModal, $rootScope) {
